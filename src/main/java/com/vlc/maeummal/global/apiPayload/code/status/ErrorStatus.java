...
public enum ErrorStatus implements BaseErrorCode {
    ...
    _NOT_FOUND_FEEDBACK(HttpStatus.INTERNAL_SERVER_ERROR, "COMMON505", "서버 에러, 데이터를 받아오지 못했습니다."),

    _NOT_FOUND_TEMPLATE(HttpStatus.INTERNAL_SERVER_ERROR, "COMMON506", "해당 데이터가 없습니다");
